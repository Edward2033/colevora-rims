...
<body class="font-sans antialiased luxury-bg min-h-screen text-gray-100" x-data="{ mobileMenuOpen: false }">
        ...
        <div class="container mx-auto px-4 py-4 md:py-8">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="glass-card rounded-2xl p-4 md:p-6 border border-gold-500/20 hover-glow">
