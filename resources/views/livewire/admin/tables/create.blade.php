...
state(['table_number' => '', 'capacity' => 4, 'location' => '', 'status' => 'available']);
...
<div>
    <div class="p-6 max-w-xl">
        <x-admin.page-header
            title="Add Table"
            :breadcrumbs="[['label'=>'Admin','url'=>route('admin.dashboard')],['label'=>'Tables','url'=>route('admin.tables.index')],['label'=>'Create']]"
        />
            ...
            <form wire:submit="save" class="space-y-5">
                ...
                <div class="flex items-center gap-3 pt-2">
                    <x-admin.btn type="submit" wire:loading.attr="disabled">
                        <span wire:loading.remove>Create Table</span>
