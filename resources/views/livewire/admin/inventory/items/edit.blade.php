...
state([
    'itemId' => null, 'name' => '', 'category_id' => '', 'supplier_id' => '',
...
$save = function () {
    ...
    InventoryItem::findOrFail($this->itemId)->update([
        'name'             => $this->name,
...
<div>
    <div class="p-6 max-w-2xl">
        <x-admin.page-header
            ...
            :breadcrumbs="[['label'=>'Admin','url'=>route('admin.dashboard')],['label'=>'Inventory','url'=>route('admin.inventory.items.index')],['label'=>'Edit']]"
        />
